...
def tcode():
    ...
    try:
        ...
        payam.config(text='!مشکلی به وجود امد',fg='red')
    Label(text='نام دقیق شخص',bg='#189AB4').place(x=295,y=200)
    nameg.place(x=380,y=200)
    Label(text='پیام',bg='#189AB4').place(x=330,y=250)
    msag.place(x=380,y=250)
    ersal0.place(x=547,y=300)
